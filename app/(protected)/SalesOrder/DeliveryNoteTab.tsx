...
import { SalesOrder, DeliveryNote } from "./types";
...
export default function Component({
  ...
  const [records, setRecords] = useState<DeliveryNote[]>([]);
    ...
    useCallback(() => {
      const initData = async () => {
        const searchParams = {
          ...
          fields: ["name", "posting_date", "docstatus", "customer"],
  ...
  return (
    <View style={styles.container}>
      <DataTable
        ...
        value={records}
        onView={(e) => {
          router.push(`/DeliveryNote/${e.name}`);
        }}
        view={true}
      />
    </View>
